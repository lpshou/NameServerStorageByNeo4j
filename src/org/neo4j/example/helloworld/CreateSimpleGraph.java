...
{
    private static final String SERVER_ROOT_URI = "http://192.168.0.187:7474/db/data/";

    public static void main( String[] args ) throws URISyntaxException
    {
        boolean serverIsRunning = checkDatabaseIsRunning();
        System.out.println(serverIsRunning);

        // START SNIPPET: nodesAndProps
      URI firstNode = createNode();
        addProperty( firstNode, "name", "liupeng" );
        URI secondNode = createNode();
        addProperty( secondNode, "band", "haha" );
    ...
    private static boolean checkDatabaseIsRunning()
    {
